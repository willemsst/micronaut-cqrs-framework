...
final class DefaultEventBus implements EventBus {
    ...
    private <I extends Id<A, I>, A extends AggregateRoot<A, I>, EM extends EventMessage<I, ? extends Record>> Mono<EM> handleEventOnListeners(EM eventMessage) {
    ...
    private <I extends Id<A, I>, A extends AggregateRoot<A, I>, EM extends EventMessage<I, ? extends Record>> Flux<CqrsEventBusHandler> getCqrsEventBusHandlers(EM eventMessage) {
